...
# Descripcion: script para realizar backup automatico de bases de datos mysql
...
mysqldump --user=$DB_USER --password=$DB_PASS --databases $DB_NAME > $BACKUP_DIR/$BACKUP_FILE
